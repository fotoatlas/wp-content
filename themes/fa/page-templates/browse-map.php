...
<?php if ( wp_is_mobile() ) : ?>
	...
	<?php echo facetwp_display( 'template', 'map' ); ?>
...
<script>
	...
	document.addEventListener('facetwp-loaded', function() {
		if (window.location.search) {
			...
			btnSwitch.setAttribute('href', site_url + '/arastir/l/' + end);
		} else {
			btnSwitch.setAttribute('href', site_url + '/arastir/l/');
		}
	});
